...
> 转自掘金大佬 [https://juejin.im/post/5c47d28051882534f33bd640](https://juejin.im/post/5c47d28051882534f33bd640)
...
>如果需要将数组按照某种规则映射为另一个数组应该用 map。<br/>
>如果需要进行简单的遍历，用 forEach 或者 for...of。<br/>
>如果需要对迭代器进行遍历，用 for...of。<br/>
>如果需要过滤出符合条件的项，用 filter。<br/>
>如果需要先按照规则映射为新数组，再根据条件过滤，那就用一个 map 加一个 filter。<br/>
>最后慎用 for...in